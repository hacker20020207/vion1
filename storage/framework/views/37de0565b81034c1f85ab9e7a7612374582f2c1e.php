...
<div id="time_content" class="d-none">
    <div id="monday_content" class="opacity_content">
        <div class="form-group mt-15">
            <input class="form-control" type="text" value="<?php echo e(trans('webinars.Monday')); ?>" readonly>
        </div>
        <div class="form-group mt-15">
            <label class="input-label d-block"><?php echo e(trans('panel.Select time')); ?></label>
            <div class="d-flex">
                <div>
    ...
    <div id="thuesday_content" class="opacity_content">
        <div class="form-group mt-15">
            <input class="form-control" type="text" value="<?php echo e(trans('webinars.Tuesday')); ?>" readonly>
        </div>
        <div class="form-group mt-15">
            <label class="input-label d-block"><?php echo e(trans('panel.Select time')); ?></label>
            <div class="d-flex">
    ...
    <div id="wednesday_content" class="opacity_content">
        <div class="form-group mt-15">
            <input class="form-control" type="text" value="<?php echo e(trans('webinars.Wednesday')); ?>" readonly>
        </div>
        <div class="form-group mt-15">
            <label class="input-label d-block"><?php echo e(trans('panel.Select time')); ?></label>
            <div class="d-flex">
    ...
    <div id="thursday_content" class="opacity_content">
        <div class="form-group mt-15">
            <input class="form-control" type="text" value="<?php echo e(trans('webinars.Thursday')); ?>" readonly>
        </div>
        <div class="form-group mt-15">
            <label class="input-label d-block"><?php echo e(trans('panel.Select time')); ?></label>
            <div class="d-flex">
    ...
    <div id="friday_content" class="opacity_content">
        <div class="form-group mt-15">
            <input class="form-control" type="text" value="<?php echo e(trans('webinars.Friday')); ?>" readonly>
        </div>
        <div class="form-group mt-15">
            <label class="input-label d-block"><?php echo e(trans('panel.Select time')); ?></label>
            <div class="d-flex">
    ...
    <div id="saturday_content" class="opacity_content">
        <div class="form-group mt-15">
            <input class="form-control" type="text" value="<?php echo e(trans('webinars.Saturday')); ?>" readonly>
        </div>
        <div class="form-group mt-15">
            <label class="input-label d-block"><?php echo e(trans('panel.Select time')); ?></label>
            <div class="d-flex">
    ...
    <div id="sunday_content" class="opacity_content">
        <div class="form-group mt-15">
            <input class="form-control" type="text" value="<?php echo e(trans('webinars.Sunday')); ?>" readonly>
        </div>
        <div class="d-flex">
            <div>
                <div class="input-group clockpicker">
...
<?php /**PATH C:\OSPanel\domains\vion1\resources\views/web/default/panel/webinar/create_includes/time_content.blade.php ENDPATH**/ ?>