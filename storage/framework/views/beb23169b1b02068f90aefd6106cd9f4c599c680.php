                                        ...
                                        <div class="btn-group dropdown table-actions">
                                            ...
                                            <div class="dropdown-menu ">
                                                ...
                                                <?php if($webinar->isCourse()): ?>
                                                    <button type="button" data-webinar-id="<?php echo e($webinar->id); ?>" class="js-webinar-next-lesson webinar-actions btn-transparent d-block"><?php echo e(trans('public.create_lesson')); ?></button>
                                                <?php endif; ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\vion1\resources\views/web/default/panel/webinar/index.blade.php ENDPATH**/ ?>