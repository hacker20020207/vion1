...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12 <?php if($webinar->isWebinar()): ?> col-md-6 <?php endif; ?>">
                <div class="form-group">
                    <label class="input-label"><?php echo e(trans('public.Course')); ?> (<?php echo e(trans('public.duration')); ?>)</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\OSPanel\domains\vion1\resources\views/web/default/panel/webinar/create_includes/step_2.blade.php ENDPATH**/ ?>