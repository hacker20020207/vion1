    ...
    <div class="container">
        ...
        <section class="mt-45">
            ...
            <div class="rounded-sm shadow mt-20 py-25 px-10 px-md-30">
                ...
                <a href="<?php echo e(url()->previous()); ?>" class="btn btn-sm btn-primary mt-25"><?php echo e(trans('cart.continue_shopping')); ?></a>
            </div>
        </section>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/usulidinumarjonov/PhpstormProjects/works/vion1/resources/views/web/default/cart/cart.blade.php ENDPATH**/ ?>