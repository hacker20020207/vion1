...
(function ($) {
  ...
  $('body').on('click', '.tab-item', function () {
    ...
    if (!$this.hasClass('active')) {
      ...
      if (type !== 'assignment') {
        addContentLoading();
        handleContent(id, type, description);
      }
    }
  });
  ...
  function handleContent(itemId, itemType, description=null) {
    console.log([itemId, itemType, description])
    var data = {
      type: itemType,
      id: itemId,
    ...
    $.post('/course/learning/itemInfo', data, function (result) {
      if (itemType === 'session') {
        ...
        handleFileHtml(result.file, description); // if file is downloadable
  ...
  function handleFileHtml(file, description='') {
      console.log([description, 'asdf'])
