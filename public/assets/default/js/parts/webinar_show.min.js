    ...
    Swal.fire({
      ...
      onOpen: function onOpen() {
        courseDemoVideoPlayer = videojs(videoTagId, options);
          // Watermark overlay yaratish
          var overlay = document.createElement('div');
          overlay.className = 'video-watermark-overlay';
          overlay.innerText = watermark;

          // CSS style berish
          overlay.style.position = 'absolute';
          // overlay.style.color = 'rgba(255, 0, 0, 0.64)';
          overlay.style.padding = '4px 8px';
          overlay.style.pointerEvents = 'none';
          overlay.style.zIndex = 100;

          // Video player elementiga qo‘shish
          courseDemoVideoPlayer.el().appendChild(overlay);
      },
    });
  });
